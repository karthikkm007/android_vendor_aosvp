...
ALARM_PATH := vendor/aosvp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aosvp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aosvp/prebuilt/common/media/audio/ringtones
